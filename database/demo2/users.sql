insert into Organization (OrganizationId, OrganizationName) values (1, 'Demo Company B');

insert into User (UserId, UserName, Password, OrganizationId, UserType) values (1, 'user1@demo.b', sha2('aRfYZoi7', 256), 1, 'General');
