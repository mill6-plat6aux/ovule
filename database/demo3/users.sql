insert into Organization (OrganizationId, OrganizationName) values (1, 'Demo Company C');

insert into User (UserId, UserName, Password, OrganizationId, UserType) values (1, 'user1@demo.c', sha2('9uHTDrJl', 256), 1, 'General');
